...
export default function Hero() {
    return(
        <section className="relative bg-[#F7F7F7] flex flex-col md:flex-row gap-10 md:gap-20 justify-between md:px-25 h-full w-full">
            <div className="w-full md:h-[716px] md:w-[613px] flex md:flex-col md:gap-[120px] md:pt-[100px] pt-[50px]">
                <div className="gap-2 flex flex-col items-center text-center md:text-left md:items-start self-start origin-left px-2 md:px-0">
                    ...
                    <p className="text-[30px] md:text-[50px] font-light">
                ...
                <div className="hidden md:block w-[395px] h-[136px] self-start">
            ...
            <Image src="/elipse.png" alt="Elipse" width={650} height={650} loading="eager" className="w-full h-auto md:w-auto md:absolute md:right-0 md:bottom-0"/>
            <Image src="/space-1.png" alt="space cadet" width={613} height={613} loading="eager" className="h-auto w-auto absolute top-100 scale-90 md:scale-100 origin-right md:top-0 right-0 md:bottom-10 z-5 mb-[30px] md:mb-0"/>
            <div className="md:hidden pl-6 w-[395px] h-[136px] self-start">
                    <div className="flex flex-row"><p className="text-[#C68313] font-semibold">Our partners </p><div className="w-[112px] border-b border-[#C68313] h-[1px] m-2 self-end"></div></div>
                    <div className="flex flex-row gap-4">
                        <Image src="/dribble.png" alt="dribble" width={112} height={36} className="self-center h-auto w-auto"/>
                        <Image src="/yahoo.png" alt="yahoo" width={112} height={112} className="h-auto w-auto"/>
